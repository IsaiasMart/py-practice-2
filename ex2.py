...
random_number=random.choice(list(range(1,101))) # fix this
print(f"Random number between 1 and 100: {random_number}")

# 5. Sample 5 numbers uniques from numbers list and print them out.
lista=list(range(1,11))
random_samples =(random.sample(lista,5)) #fix this
...
dice_roll = random.choice(list(range(1, 7))) # fix this
...
# hint: use int(input("..."))
user_number = int(input("choose a number"))# fix this
random_number = random.choice(list(range(1, user_number))) # fix this, random number from 1 to user_number
...
user_guess = int(input("choose a number from 1 to 10")) # fix this, hint: use int(input("..."))
random_number = random.choice(list(range(1,11))) # fix this, random number from 1 to 10
if user_guess == random_number:
  print("You guessed correctly!")
else:
  print("You guessed incorrectly.")
  print(f"this was the number you couln't guess {random_number}")
